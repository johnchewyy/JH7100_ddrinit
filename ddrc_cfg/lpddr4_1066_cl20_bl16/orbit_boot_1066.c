...
void orbit_boot(uint32_t OMC_APB_BASE_ADDR, uint32_t OMC_SECURE_APB_BASE_ADDR, uint32_t PHY_APB_BASE_ADDR, u32 ddr_num)
{
    ...
    apb_write(OMC_APB_BASE_ADDR + 0x600, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x604, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x608, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x60c, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x610, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x614, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x618, 0x001700bb);
    apb_write(OMC_APB_BASE_ADDR + 0x61c, 0x001700bb);
    ...
    // timing_reg->trcd = 0x14;
    //default value: 0x402d0894
    apb_write(OMC_APB_BASE_ADDR + 0x628, 0x402d0880);//tRC[31:24]>=(0x60||0x63)/tCK,tRAS[22:16]>=0x44,tRTP[13:8]>=0xc,adv_al[7]=1,tRCD[5:0]>=0x1d
    ...
    apb_write(OMC_APB_BASE_ADDR + 0x0, 0x00000001);
    apb_write(OMC_APB_BASE_ADDR + 0x108, 0x00000000);
    apb_write(OMC_SECURE_APB_BASE_ADDR + 0x704, 0x00000007);
    //okay
    apb_write(OMC_APB_BASE_ADDR + 0x628, 0x402d0894); //test
    ...
    apb_write(OMC_APB_BASE_ADDR + 0x20, 0x00000001); //DDR INIT COMPLETE
}

void orbit_boot2(uint32_t OMC_APB_BASE_ADDR, uint32_t OMC_SECURE_APB_BASE_ADDR, uint32_t PHY_APB_BASE_ADDR, u32 ddr_num)
{
    u32 tmp = 0;
    int count = 0;
    int i = 0;
